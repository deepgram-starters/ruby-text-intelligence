# Ruby Text Intelligence Makefile
...
help:
	@echo "Ruby Text Intelligence - Available Commands"
	@echo "============================================"
	@echo ""
	@echo "Setup:"
...
check-prereqs:
	...
	@command -v ruby >/dev/null 2>&1 || { echo "❌ ruby is required but not installed. Visit https://www.ruby-lang.org"; exit 1; }
	@command -v bundle >/dev/null 2>&1 || { echo "❌ bundler is required but not installed. Run: gem install bundler"; exit 1; }
